...
import beepLogo from 'figma:asset/18fd225793878456a38181d840b09a1277cbba6c.png';
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="flex flex-col sm:flex-row gap-3">
                <Input
                  ...
                  className="flex-1 bg-white/10 border-white/20 text-white placeholder-gray-400 focus:border-white/40 focus:bg-white/20 backdrop-blur-sm"
                  required
                />
                <Button
                  type="submit"
                  disabled={isSubmitting}
                  className="bg-white text-black hover:bg-gray-200 font-medium px-8 py-2 transition-colors"
                >
